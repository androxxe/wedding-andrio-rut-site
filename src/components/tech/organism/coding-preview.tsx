      ...
      <div className="border-b border-b-slate-800">
        <TabsList className="bg-transparent">
          <TabsTrigger value="preview" asChild={true}>
            <button className="px-4 py-2 text-sm font-medium text-slate-400 data-[state=active]:bg-transparent data-[state=active]:text-white data-[state=active]:font-bold data-[state=active]:border-b-2 border-white rounded-none">
              Preview
            </button>
          </TabsTrigger>
