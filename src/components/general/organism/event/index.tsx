...
const ListEvent = (props: ListEventProps) => {
  ...
  return (
    <div className="text-center space-y-2 py-8">
      ...
      <p className={cn(ebGaramond.className, "text-lg pt-2")}>{location}</p>
    </div>
  );
};
...
export const Event = () => {
  ...
  return (
    <div className="w-full h-full p-3 lg:p-12 bg-[url(/images/theme/general/main-pattern.jpg)] bg-[length:16rem_16rem]">
      <div className="bg-gold-200 h-full rounded-md shadow-sm px-5 py-8 lg:py-12 overflow-y-auto">
        <h2 className={cn(viaodaLibre.className, "text-4xl text-center mb-8")}>Save The Date</h2>
        <ListEvent
