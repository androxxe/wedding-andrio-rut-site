...
export const Cover = () => {
  return (
    <div className="h-screen flex flex-col relative bg-[url(/images/theme/general/main-pattern.jpg)] bg-[length:16rem_16rem]">
      ...
      <div className="flex flex-col items-center justify-center z-10 pb-48 space-y-5">
        ...
        <button className="bg-gold-200 duration-200 hover:bg-gray-200 rounded-md px-3 py-2 text-sm">
          Buka Undangan
        </button>
      </div>
